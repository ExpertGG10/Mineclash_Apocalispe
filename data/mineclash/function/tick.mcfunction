...
execute as @e[nbt={inGround:true, weapon:{components:{"minecraft:custom_data":{peste:true}}}}] run execute as @s run function mineclash:peste/roletinha
...
execute as @a[tag=a_peste] run execute unless items entity @s container.* #arrows run schedule function mineclash:peste/roleta 40
